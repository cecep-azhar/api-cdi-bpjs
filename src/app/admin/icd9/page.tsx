...
export default function ICD9Page() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await fetch("/api/icd9");
  ...
  const handleDownloadSample = () => {
    const content = "code,name_id,name_en,is_active\n001.0,Kolera akibat Vibrio cholerae,Cholera due to Vibrio cholerae,1\n002.0,Demam paratifoid,Paratyphoid fever,1";
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="admin-card">
        <div className="card-header">
          <h2 className="card-title">ICD-9 List</h2>
        ...
        <div className="card-content" style={{ padding: 0 }}>
          {loading ? (
            ...
            <div style={{ padding: "5rem", textAlign: "center" }}>
              ...
              <p style={{ color: "#94a3b8", fontWeight: 500 }}>No ICD-9 data yet</p>
            </div>
          ) : (
